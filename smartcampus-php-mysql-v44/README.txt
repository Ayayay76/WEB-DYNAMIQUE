SMARTCAMPUS - VERSION v44 PHP / MYSQL
=====================================
...
BASE DE DONNÉES
---------------
- Base MySQL : smartcampus_v44
- Fichier à importer : database_v44.sql
- Copie identique fournie : database.sql

INSTALLATION
------------
1. Copier le dossier smartcampus-php-mysql-v44 dans :
   C:\MAMP\htdocs\
...
4. Vérifier api/config.php :
   define('DB_NAME', 'smartcampus_v44');
   define('DB_USER', 'root');
   define('DB_PASS', 'root');

5. Ouvrir :
   http://localhost/smartcampus-php-mysql-v44
...
---------------------------
La version v44 couvre les espaces administrateur, étudiant et enseignant, la navigation par rôle, les comptes, les étudiants, les enseignants, les cours, les modules, les classes, les inscriptions, les notes, les présences, l'emploi du temps, les messages et notifications.
...
- database_v44.sql : script SQL à importer.
...
CORRECTIONS v44 - SESSION ET INTERFACE
...
CORRECTIONS v44
- Session isolée avec cookie SMARTCAMPUS_V44_SESSION pour éviter une connexion automatique héritée d'une ancienne version ou d'un ancien dossier.
...
- Ajout d'un cache-busting app.js?v=44 et style.css?v=44 pour éviter que le navigateur garde l'ancien code.


CORRECTIONS v44 - FILTRAGE ET NOTES
-----------------------------------
...
CORRECTIONS v44 - ÉTUDIANTS ET ÉVÉNEMENTS
-----------------------------------------
...
CORRECTIONS v44 - PONDÉRATION DES NOTES PAR TYPE
------------------------------------------------
