CREATE DATABASE IF NOT EXISTS smartcampus_v44
...
INSERT INTO modules (id, code, name, semester) VALUES
(1, 'MOD-WEB-BDD', 'Module Web & Bases de données', 'S4'),
(2, 'MOD-MATH', 'Module Mathématiques appliquées', 'S4');
